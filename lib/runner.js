...
var Runner = module.exports = function(adapter) {
  this.migrateDir = path.join(config.paths.root, config.paths.db.migrate);
  this.adapter = adapter || new (require('./adapter'))();
}
